...
export default function RootLayout({ children }: { children: ReactNode }) {
  ...
  const mensagem = encodeURIComponent(
    "Olá, vim pelo site do ESFERA e gostaria de mais informações.",
  );
      ...
      <body>
        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
          <a
            ...
            className="flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-lg transition hover:bg-green-600"
          >
            <svg
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Instagram do ESFERA"
            className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 shadow-lg transition hover:opacity-90"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="YouTube do ESFERA"
            className="flex h-14 w-14 items-center justify-center rounded-full bg-red-600 shadow-lg transition hover:bg-red-700"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
