...
function DadosCadastraisConteudo() {
  ...
  const [modalidade] = useState(searchParams.get("modalidade") || "");
          ...
          {formaContratacao && (
            <p className="text-xs text-white/50 mb-4 bg-white/5 rounded-lg px-3 py-2">
              ...
              <span className="text-white">
                ...
                {nivel && ` — ${NIVEIS.find((n) => n.value === nivel)?.label}`}
                {modalidade &&
                ...
                {matriculadoColegio === "sim" && (
                  <div className="flex flex-col gap-2 mt-3">
                    <div className="flex flex-col gap-2">
                      {NIVEIS.filter((n) => n.value !== "superior").map((n) => (
                        <button
                          key={n.value}
                          type="button"
                          onClick={() => {
                  ...
                  <div className="flex flex-col gap-2 mt-3">
                    ...
                    {cursoSuperior === "Outros" && (
                      <input
                        ...
                        onChange={(e) => setCursoSuperiorOutro(e.target.value)}
            ...
            <div className="flex flex-col gap-3">
              ...
              {!respEhAluno && (
                <>
                  ...
                  >
                    <span>{respMesmoEndereco ? "✓" : "○"}</span> Mesmo endereço
                    do(a) aluno(a)
                  </button>
...
export default function DadosCadastraisPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#08364E]" />}>
      <DadosCadastraisConteudo />
    </Suspense>
  );
}
