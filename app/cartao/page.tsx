...
const whatsapp =
  "https://wa.me/5511953618314?text=Ol%C3%A1!%20Gostaria%20de%20informa%C3%A7%C3%B5es%20sobre%20as%20aulas%20particulares%20do%20ESFERA.";
    ...
    <div className="min-h-screen bg-[#08364E] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          >
            <defs>
              <radialGradient id="esferaGrad" cx="38%" cy="33%" r="70%" fx="36%" fy="30%">
            ...
            <circle cx="50" cy="50" r="48" fill="none" stroke="#3A9FD0" strokeWidth="0.5" opacity="0.2" />
          </svg>
          ...
          {links.map((link) => (
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-xs font-medium opacity-75">{link.sublabel}</span>
